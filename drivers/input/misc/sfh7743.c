...
static long sfh7743_misc_ioctl(struct file *file,unsigned int cmd, unsigned long arg)
{
...
static const struct file_operations sfh7743_misc_fops = {
	...
	.unlocked_ioctl = sfh7743_misc_ioctl,
};
...
static int sfh7743_input_init(struct sfh7743_data *sfh)
{
	...
	sfh->input_dev->phys = "sfh7743/input0";
	sfh->input_dev->dev.parent = &sfh->pdev->dev;
	sfh->input_dev->id.bustype = BUS_HOST;
	__set_bit(EV_ABS, sfh->input_dev->evbit);

	input_set_abs_params(sfh->input_dev, ABS_DISTANCE, 0, 1, 0, 0);
