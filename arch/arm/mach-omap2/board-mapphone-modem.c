...
/*enable to force qsc6085 using sholes gpios
easier to hack this up for testing than adding the gpios to DT*/
#define HACK
...
#else
	printk("using hardcoded GPIOs\n");
	qsc6085_ctrl_platform_data.gpio_flash_enable = 157;
	qsc6085_ctrl_platform_data.gpio_power = 137;
	qsc6085_ctrl_platform_data.gpio_pshold = 138;
	qsc6085_ctrl_platform_data.gpio_reset_out = 139;
#endif
