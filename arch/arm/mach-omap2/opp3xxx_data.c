...
//TODO: try changing clocks to "l3_ick"
	OPP_INITIALIZER("l3_main", "l3_ick", "core", false,  41500000, OMAP3430_VDD_CORE_OPP1_UV),			//32
	/* L3 OPP2 */
	OPP_INITIALIZER("l3_main", "l3_ick", "core", true,   83000000, OMAP3430_VDD_CORE_OPP2_UV),			//39
	/* L3 OPP3 */
	OPP_INITIALIZER("l3_main", "l3_ick", "core", true,  166000000, OMAP3430_VDD_CORE_OPP3_UV), //45		//46
	/*overclock*/
	OPP_INITIALIZER("l3_main", "l3_ick", "core", false, 200000000, OMAP3430_VDD_CORE_OPP3_UV),
